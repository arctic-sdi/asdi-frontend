...
Oskari.clazz.define('Oskari.projection.change.view.ProjectionInformation', function (projection) {
    ...
    this.infoView = _.template('<div class="oskari-projection-information"><i>${desc}</i><br/><img class="projection-preview-image" src="/Oskari/bundles/asdi-projection-change/resources/images/${img}"></img></div>');
}, {
